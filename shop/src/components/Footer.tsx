...
const footerLinks = [
  {
    title: "Repairs",
    links: [
      { label: "iPhone repair", href: "https://jesupwireless.com/repairs/smartphone/iphone" },
      { label: "Samsung repair", href: "https://jesupwireless.com/repairs/smartphone/samsung" },
      { label: "Google repair", href: "https://jesupwireless.com/repairs/smartphone/google" },
      { label: "Motorola repair", href: "https://jesupwireless.com/repairs/smartphone/motorola" },
      { label: "Tablet repair", href: "https://jesupwireless.com/repairs/tablets" },
      { label: "Computer repair", href: "https://jesupwireless.com/repairs/laptop-computers" },
      { label: "Game console repair", href: "https://jesupwireless.com/repairs/gaming-console" },
      { label: "All repairs", href: "https://jesupwireless.com/repairs/smartphone" },
    ],
  },
  {
    title: "Support",
    links: [
      { label: "FAQ", href: "https://jesupwireless.com/faq" },
      { label: "Track order", href: "/track-order" },
      { label: "Start a repair", href: "https://jesupwireless.com/appointment" },
      { label: "Contact us", href: "https://jesupwireless.com/contact" },
    ],
  },
  {
    title: "Shop",
