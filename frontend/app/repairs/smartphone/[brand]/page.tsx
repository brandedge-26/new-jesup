...
import {
  ...
  Wifi, ScanFace, Fingerprint, Wrench, Pen, SlidersHorizontal,
  Trophy, Zap, Search, BadgeDollarSign, Shield, Smartphone,
  MapPin, CalendarCheck, CheckCircle2,
} from "lucide-react";
import { brands, type Issue } from "./brandData";
...
export async function generateMetadata({ params }: { params: Promise<{ brand: string }> }) {
  ...
  if (!data) return {};
  return { title: `${data.name} Repair | Jesup`, description: data.description };
}

/* ── icon map ── */
const iconMap: Record<string, React.ElementType> = {
  Monitor, Battery, PlugZap, Camera, Layers, Volume2, Droplets,
  Wifi, ScanFace, Fingerprint, Wrench, Pen, SlidersHorizontal, Smartphone,
};
...
const crossSell = [
  ...
  { label: "Google Pixel", image: "/header-images/phone-repair/google.png",   href: "/repairs/smartphone/google" },
  { label: "Motorola",     image: "/header-images/phone-repair/motorola.png", href: "/repairs/smartphone/motorola" },
  { label: "LG",           image: "/header-images/phone-repair/LG.png",       href: "/repairs/smartphone/lg" },
  { label: "iPad",         image: "/header-images/tech-repair/ipad.png",      href: "/repairs/tablets/ipads" },
];

export default async function SmartphoneBrandPage({ params }: { params: Promise<{ brand: string }> }) {
  const { brand } = await params;
  const data = brands[brand];
  if (!data) notFound();
    ...
    <main className="flex-1 bg-white">
      ...
      <section className="bg-white border-b border-gray-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 2xl:px-16 py-14 lg:py-20 grid lg:grid-cols-2 gap-10 items-center">
          ...
          {/* RIGHT — brand product image, bg removed via isolation */}
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md h-[380px] lg:h-[440px] bg-white">
              {/* purple glow layer — sits behind */}
      ...
      <section className="bg-primary overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 2xl:px-16 py-10 grid lg:grid-cols-[1fr_auto] gap-8 items-center">
          <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { step: 2, Icon: Wrench,        title: "Get quality repairs", desc: `Our techs diagnose your ${data.name} and fix it fast with OEM-quality parts.` },
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {data.models.slice(0, 4).map((model, i) => (
              <div key={i} className="bg-white rounded-2xl border border-gray-200 p-5 hover:shadow-md hover:border-primary/30 transition-all duration-200">
                <Stars />
                <p className="font-bold text-gray-900 text-sm mt-3 mb-1">{model.name}</p>
      ...
      <section className="py-16 px-6 lg:px-10 2xl:px-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">
            {data.name} phone repair at Jesup
          </h2>
      ...
      <section className="py-16 px-6 lg:px-10 2xl:px-16 bg-gray-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="rounded-3xl overflow-hidden grid lg:grid-cols-[1fr_400px] bg-white border border-gray-200 shadow-sm">
            ...
            {/* brand image panel — bg blended out */}
      ...
      <section className="py-16 px-6 lg:px-10 2xl:px-16 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-4">
            {crossSell
              .filter((d) => d.href !== `/repairs/smartphone/${data.slug}`)
              .map((device) => (
